...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \MageWorx\ShippingRules\Model\RuleFactory $ruleFactory
     * @param array $data
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_eventManager->dispatch(
            'adminhtml_block_shippingrules_widget_chooser_prepare_collection',
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('mageworx_shippingrules/shippingrules_quote/chooser', ['uniq_id' => $uniqId]);
    ...
    /**
     * Prepare columns for shipping rules grid
     *
     * @return $this
     */
    ...
    {
        return $this->getUrl('mageworx_shippingrules/shippingrules_quote/chooser', ['_current' => true]);
    }
}
