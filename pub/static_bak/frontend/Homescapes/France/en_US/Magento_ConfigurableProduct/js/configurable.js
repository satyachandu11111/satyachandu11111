...
define([
    ...
    $.widget('mage.configurable', {
        ...
        _configureElement: function (element) {
            ...
            this._checkStockDetails(this.simpleProduct);
            if (element.value) {
        ...
        _displayRegularPriceBlock: function (optionId) {
            if (typeof optionId != 'undefined' &&
                ...
                if(oldpricecus != "" && newpricecus != "") {
                    $('.product-info-discount .g-discount').html('{ -'+Math.round(dis_per)+' %}');
                }    
         ...
         * @private
         */
        _checkStockDetails: function (product) {
           
                    //Ajax Request : 
                    var productid=product;
                    var parentProductId= $("#product_addtocart_form input[name=product]").val();

                    var customurl = urlBuilder.build('customxnotif/index/index/');
                    ...
                    $.ajax({
                       ...
                       complete: function(response) {             
                        ...
                        if(response.responseJSON.status=='out-of-stock'){
                            $("#product-addtocart-button").prop('disabled', true);
                            $("#confi-stock-notigication").show();
                        $('#confi-stock-notigication').html(response.responseJSON.popup);
                        }else{
                            $("#product-addtocart-button").prop('disabled', false);
                            $("#confi-stock-notigication").hide();
                        }
                ...
                //console.log('Position is : '+ index + '  And  Value is : ' + elementvalue);
         ...
         * @private
         */
        _hideStockDetails: function (elements) {
            $("#confi-stock-notigication").hide();
            $("#product-addtocart-button").prop('disabled', false);
        },
